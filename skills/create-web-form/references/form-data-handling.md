...
```html
<input type="text" minlength="6" maxlength="6" /> <textarea maxlength="140"></textarea>
```
...
```html
<input type="number" min="1" max="10" step="1" /> <input type="date" min="2024-01-01" max="2024-12-31" />
```
...
<form>
  ...
  <p>
    ...
    <input type="text" id="fruit" name="fruit" list="fruits" required pattern="[Bb]anana|[Cc]herry|[Aa]pple" />
    <datalist id="fruits">
