...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90% (generated after mount to avoid calling impure functions during render).
  const [width, setWidth] = React.useState<string>("75%"); // fallback until effect runs
  React.useEffect(() => {
