...
// BadgeProps, ButtonProps, and PopoverContentProps are not exported from their modules.
// Use ComponentProps<typeof Badge>, ComponentProps<typeof Button>, and ComponentProps<typeof PopoverContent> instead.
...
export const TagsContent = ({ className, children, ...props }: React.ComponentProps<typeof PopoverContent>) => {
