...
const envSchema = z.object({
  ...
  AUTH_TRUST_HOST: z.string().transform((v) => v === 'true').optional(),
  ...
  // ========== FEATURES ==========
  ENABLE_SEEDING: z.string().transform((v) => v === 'true').pipe(z.boolean()).default(false),
  ENABLE_ANALYTICS: z.string().transform((v) => v === 'true').pipe(z.boolean()).default(true),
  ENABLE_ERROR_TRACKING: z.string().transform((v) => v === 'true').pipe(z.boolean()).default(true),
