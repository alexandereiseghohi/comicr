        ...
        <div className="text-center">
          <div className="mb-8">
            ...
            <p className="mb-4 text-slate-400">
              We&apos;ve sent you an email with a link to verify your account. Please check your inbox and click the
              link to continue.
            </p>
          </div>
          ...
          <div className="mb-6 rounded-lg border border-slate-700 bg-slate-800 p-4">
            <p className="text-sm text-slate-300">
              <strong>Didn&apos;t receive an email?</strong> Check your spam folder or try signing up again.
            </p>
          </div>
