    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="lead mb-8 text-lg">
          Please read these Terms of Service carefully before using ComicWise. By accessing or using
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="acceptance">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                By creating an account, accessing, or using the ComicWise platform, you acknowledge
          ...
          <AccordionItem value="accounts">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                To access certain features of ComicWise, you must create an account. You are
                responsible for:
              </p>
          ...
          <AccordionItem value="content">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                ComicWise provides access to comic content for personal, non-commercial use only.
                You agree to:
              </p>
              <ul className="list-disc space-y-2 pl-6">
              ...
              <p>
                User-generated content (comments, ratings, reviews) must not contain offensive,
                illegal, or inappropriate material. We reserve the right to remove any content that
          ...
          <AccordionItem value="intellectual-property">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                All content available on ComicWise, including but not limited to comics, images,
                text, graphics, logos, and software, is protected by copyright, trademark, and other
                intellectual property laws.
              </p>
              <p>
                The ComicWise name, logo, and all related names, logos, product and service names,
                designs, and slogans are trademarks of ComicWise or its affiliates. You may not use
                such marks without prior written permission.
              </p>
              <p>
                Content creators retain all rights to their original works. By using our platform,
                you agree to respect these rights and report any copyright infringement.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="limitation">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, COMICWISE SHALL NOT BE LIABLE FOR ANY
                INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF
                PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA,
                USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
              </p>
              <p>
                Our total liability in any matter arising out of or related to these terms is
                limited to the amount you paid us in the 12 months prior to the event giving rise to
                the liability.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="termination">
            ...
            <AccordionContent className="space-y-4 text-base">
              ...
              <p>
                ...
                survive, including intellectual property provisions, disclaimers, and limitations of
                liability.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="governing-law">
            ...
            <AccordionContent className="space-y-4 text-base">
              ...
              <p>
                ...
                resolved through binding arbitration, except that either party may seek injunctive
                or other equitable relief in court.
              </p>
              <p>
          ...
          <AccordionItem value="miscellaneous">
            ...
            <AccordionContent className="space-y-4 text-base">
              <p>
                ...
                between you and ComicWise regarding the service and supersede all prior agreements.
              </p>
              <p>
