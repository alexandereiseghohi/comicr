...
1. fix Sorry, your request failed. Please try again.Copilot Request id: b5635c23-fc96-4b0a-8114-0f53dc65485aGH Request Id: 0EC8:24AAA0:FDEAD:1253F2:6985088EReason: Request Failed: 400 {"error":{"message":"This model's maximum context length is 128000 tokens. However, you requested 133072 tokens (104703 in the messages, 11985 in the functions, and 16384 in the completion). Please reduce the length of the messages, functions, or completion.","code":"invalid_request_body"}}
2. Collect and fix all errors, warnings, and deprecations from the output of these commands following project conventions and best practices..
3. Auto-format the entire codebase (run pnpm lint:fix).
4. Rerun all scripts to confirm that all warnings and errors are resolved.
